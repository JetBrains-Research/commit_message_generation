...
python train.py +model=random_roberta_2_random_gpt2_2 ++dataset.train_with_history=false ++wandb_logger.project=test ++trainer.accelerator="$2" ++trainer.devices=1 ++trainer.limit_train_batches=100 ++trainer.limit_val_batches=100 ++dataset.use_cache=true
...
python train.py +model=random_roberta_2_random_gpt2_2 ++dataset.encoder_input_type=history ++wandb_logger.project=test ++trainer.accelerator="$2" ++trainer.devices=1 ++trainer.limit_train_batches=100 ++trainer.limit_val_batches=100 ++dataset.use_cache=true
...
python train.py +model=random_roberta_2_random_gpt2_2 ++dataset.train_with_history=true ++wandb_logger.project=test ++trainer.accelerator="$2" ++trainer.devices=1 ++trainer.limit_train_batches=100 ++trainer.limit_val_batches=100 ++dataset.use_cache=true
...
python train.py +model=distilgpt2 ++wandb_logger.project=test ++trainer.accelerator="$2" ++trainer.devices=1 ++trainer.limit_train_batches=100 ++trainer.limit_val_batches=100 ++dataset.use_cache=true
