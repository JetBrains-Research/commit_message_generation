...
def test_random_example():
    ...
    assert ExactMatch(n=2)(str1, str2) == pytest.approx(0.0)
    assert ExactMatch(n=3)(str1, str2) == pytest.approx(0.0)
    assert ExactMatch(n=4)(str1, str2) == pytest.approx(0.0)
    assert ExactMatch(n=5)(str1, str2) == pytest.approx(0.0)
